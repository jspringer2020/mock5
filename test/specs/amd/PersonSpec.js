...
define(["Squire", "jquery"], function (Squire, $) {
  ...
  describe("Person", function () {
    ...
    beforeEach(function () {
      ...
      //    Currently there are no mocked dependencies, but we are adding them here for reference.    
      //    longShotCalculatorMock = sinon.stub();
      //    injector.mock("amd/LongShotCalculationProvider", longShotCalculatorMock);
    });


    function getModule(promise) {
      injector.require(["amd/Person"], function (Constructor) {
      ...
      beforeEach(function () {
        ...
        getModule(promise)
          .then(function (Person) {
            var target = new Person(chance.bool(), name);
