define(["Squire", "jquery"], function (Squire, $) {
  ...
  describe("MarriageProposal", function () {
    var injector, PersonConstructorMock, personalHistoryProviderMock, longShotCalculatorMock;
    ...
    beforeEach(function() {
      ...
      injector.mock("amd/PersonalHistoryProvider", personalHistoryProviderMock);
    ...
    describe("when performing a marriage proposal", function () {
      ...
      describe("when the proposal is invalid", function () {
        ...
        beforeEach(function () {
          ...
          execution = function () {
            target.performMarriageProposal();
          };
        });
